 ...
 */
    ...
    var dt = 25 / 60;              // This variable controls the speed of time (higher = faster simulation)
    ...
    class Obj  {
        ...
        update()  {
            ...
            if (this.name == "fuse virtuelle" && global.rocketSimStarted)  {
                ...
                global.teta = Math.PI;
                global.facteurDeCorrection = 2.5;
				
				if (time < 30) {
					virtualFuse.addForce(22821000 * global.facteurDeCorrection * cos(global.teta), 22821000 * global.facteurDeCorrection * sin(global.teta), 0);
					virtualFuse.mass -= (8275.168 * dt);					
				}
				
				if (30 <= time && time < 149) {
					virtualFuse.addForce(21130700* global.facteurDeCorrection * cos(global.teta), 21130700 * global.facteurDeCorrection * sin(global.teta), 0);
					virtualFuse.mass -= (7662.25 * dt);
				}

				if (149 <= time && time < 174) {
					virtualFuse.addForce(5916720 * global.facteurDeCorrection * cos(global.teta), 5916720 * global.facteurDeCorrection * sin(global.teta), 0);
				...
				if(178 <= time && time < 511){
					...
					virtualFuse.addForce(934000 * global.facteurDeCorrection * cos(global.teta), 934000 * global.facteurDeCorrection * sin(global.teta), 0);
    ...
    class Planet  extends Obj  {
        ...
        constructor(r, m, rs, src, p, v)    {
            ...
            // Pour les anneaux de saturn et uranus
            this.ring;
            if (settings.showTextures)  {                
                if (this.name == "saturn")  {
