 ...
 */
	...
	itemsMenuWindow.onopen = function()	{
		...
		// Resetting the item's window componenets
		windowElements = [];
					...
					<fieldset>
						...
						<table>
							<tr>
								...
								<td>
									<input type="button" value="Game not over" OnClick="gameOver = false; player.hp = player.maxHp * 0.50" />
								</td>
							</tr>	
							<tr>
								<td>
								...
								<td>
									<input type="button" value="level up" OnClick="window.consoleLoaded = false; loadLevel${level + 1}(); level++;" />
								</td>
								<td>
									<input type="button" value="level down" OnClick="window.consoleLoaded = false; loadLevel${level - 1}(); level--;" />
								</td>
								<td>
